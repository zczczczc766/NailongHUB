...
local C=B:CreateWindow({
    Icon="crown",
    Title=gradient("被遗弃角色|皮肤切换器",Color3.fromRGB(255,235,120),Color3.fromRGB(255,170,0)),
    Author=gradient("@墨水依旧",Color3.fromRGB(255,235,120),Color3.fromRGB(255,170,0)),
    Folder="被遗弃角色|皮肤切换器",
